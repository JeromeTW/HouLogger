#
# Be sure to run `pod lib lint HouLogger.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HouLogger'
  s.version          = '1.0.2'
  s.summary          = 'A short description of HouLogger.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/JeromeTW/HouLogger.git', :tag => s.version.to_s }
